...
import Frontend.GradeCellRenderer;
...
public class StudentPanel extends javax.swing.JFrame implements StudentTeacher {
    ...
    private void extractDetails() {
        try {
            ...
            if (result.next()) {
                ...
                new Person(this.fName, this.lName, id, this.course, role, this.courseId);
    ...
    private void initComponents() {
        ...
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jPanel12, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE)
        ...
        questionsPanelLayout.setHorizontalGroup(
            ...
            .addComponent(jPanel26, javax.swing.GroupLayout.DEFAULT_SIZE, 839, Short.MAX_VALUE)
        );
